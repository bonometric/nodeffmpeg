...
app.use(cors({
  credentials: true, 
  origin:[ 'http://192.168.0.135:8000','http://orrys-r1.local:8000/','http://localhost:8080','http://flyingbits.ddns.net:13370/','http://flyingbits.ddns.net:13375', 'http://192.168.0.110:8080']
}));
